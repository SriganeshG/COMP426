...
Card.RankStrings = ["", "", "Two", "Three", "Four", "Five", "Six", "Seven", "Eight", "Nine", "Ten", "Jack", "Queen", "King", "Ace"];
...
var Hand = function (dealt_cards, player_key, game) {
    ...
    this.contains = function (card, key) {
        ...
        return (dealt_cards.find(function (c) {
    ...
    this.removePassedCard = function (card, key) {
        ...
        var card_from_unplayed = unplayed_cards.find(function (c) {
            return c.equals(card);
        });
    ...
    this.markCardPlayed = function (card, key) {
        ...
        var actual_card = unplayed_cards.find(function (c) {
...
var Trick = function (next_to_play, trick_key) {
    ...
    this.hasPoints = function () {
        return trick_cards.find(function (c) {
            return c.pointValue() > 0;
        }) != undefined;
    }
