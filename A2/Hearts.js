...
var GameOfHearts = function (pass, options) {
    ...
    var startFirstTrick = function () {
        ...
        while (!found) {
            ...
            var found_two = unplayed_cards.find(function (c) {
                return c.equals(two_of_clubs);
            });
...
GameStartedEvent.prototype.toString = function () {
    ...
    switch (this.getPassType()) {
        case Hearts.PASS_LEFT:
            str += "passing left.";
            break;
        case Hearts.PASS_RIGHT:
            str += "passing right.";
            break;
        case Hearts.PASS_ACROSS:
            str += "passing across.";
            break;
        case Hearts.PASS_NONE:
            str += "no pass.";
            break;
    }
    return str;
